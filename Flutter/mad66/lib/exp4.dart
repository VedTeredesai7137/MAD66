// Exp4 - Multi-Step Form
// Name: Divyam Navin
// Roll No.: 5023134
// Practical - 4
// Aim: Implement an interactive multi-step registration form.
...
class _MultiStepFormScreenState extends State<MultiStepFormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Experiment 4 - Multi-Step Form')),
      body: Form(
        key: _formKey,
        child: Stepper(
